...
\newcommand{\complexity}{\textbf{Complexity}\xspace}
...
\newcommand{\postupdate}{\textsc{PosteriorUpdate}\xspace}
%\DeclareMathOperator{\breg}{Breg}
\newcommand{\breg}{\textup{Breg}}
\newcommand{\est}{\textbf{\textup{Est}}\xspace}
%\newcommand{\picirc}{\mathring{\pi}}
\newcommand{\picirc}{\pi_{\phi^\star}}
\newcommand{\tilD}{\overline{D}}
...
\newcommand{\dimm}{\mathsf{dcdim}}
\newcommand{\hatP}{\widehat{P}}
\newcommand{\bi}{\mathsf{av}}
\newcommand{\sbe}{\mathsf{sq}}
\newcommand{\hbi}{\mathsf{av}}
\newcommand{\hsbe}{\mathsf{sq}}
\newcommand{\decname}{Dig-DEC\xspace}
\newcommand{\conc}{\mathsf{conc}}
\newcommand{\tra}{\textbf{\textup{TermA}}}
\newcommand{\qcom}{\textbf{\textup{TermB}}}
\newcommand{\rew}{\textbf{\textup{TermC}}}
%\newcommand{\leftt}{{\tiny{\textcircled{\textsf{1}}}}}
%\newcommand{\rightt}{{\tiny{\textcircled{\textsf{2}}}}}
\newcommand{\leftt}{-}
\newcommand{\rightt}{+}
...
\newrefformat{foot}{\savehyperref{#1}{Footnote~\ref*{#1}}}
...
\newcommand{\mfdec}{\mathsf{dig}\text{-}\mathsf{dec}}
